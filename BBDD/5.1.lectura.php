    ...
    <body>
        ...
        <?php
            ...
            while($resultado=mysqli_fetch_array($linea)){
                ...
                echo "<form action='5.update.php' method='post'>";
                echo "<input type='text' name='idtabla' value='" . $resultado['idtabla'] ."'><br> ";
                echo "<input type='text' name='nombre' value='" . $resultado['nombre'] ."'><br> ";
                echo "<input type='text' name='numero' value='" . $resultado['numero'] ."'><br> ";
